...
def main():
    outputFile1 = open('../../data/raw/MillionSongSubset/SongCSV.csv', 'w')
    csvRowString = ""
    ...
    # the user,
        ...
        csvRowString = ("SongID,AlbumID,AlbumName,ArtistID,ArtistLatitude,ArtistLocation," +
                        ...
                        "Title,Year,ArtistFamiliarity,ArtistHotttnesss,SongHotttnesss,EndOfFadeIn,Energy,Loudness,StartOfFadeOut")
        #################################################
    ...
    basedir = "../../../src/data/raw/MillionSongSubset"  # "." As the default means the current directory
    ...
    for root, dirs, files in os.walk(basedir):
        ...
        for f in files:
            ...
            for attribute in csvAttributeList:
               ...
               # elif attribute == 'ArtistTermsFreq'.lower():
                    #csvRowString += "\"" + song.artistTermsFreq + "\""
                #elif attribute == 'ArtistTermsWeight'.lower():
